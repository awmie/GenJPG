...
function P() {
  ...
  for (i.sort(e); n2 = i.shift(); )
    n2.__d && (u2 = i.length, r2 = void 0, f2 = (o2 = (t2 = n2).__v).__e, c2 = [], s2 = [], t2.__P && ((r2 = w({}, o2)).__v = o2.__v + 1, l.vnode && l.vnode(r2), j(t2.__P, r2, o2, t2.__n, t2.__P.namespaceURI, 32 & o2.__u ? [f2] : null, c2, null == f2 ? C(o2) : f2, !!(32 & o2.__u), s2), r2.__v = o2.__v, r2.__.__k[r2.__i] = r2, z(c2, r2, s2), r2.__e != f2 && S(r2)), i.length > u2 && i.sort(e));
  P.__r = 0;
}
function $(n2, l2, u2, t2, i2, r2, o2, e2, f2, c2, s2) {
  ...
  for (f2 = I(u2, l2, g2, f2, m2), a2 = 0; a2 < m2; a2++)
    null != (y2 = u2.__k[a2]) && (h2 = -1 === y2.__i ? p : g2[y2.__i] || p, y2.__i = a2, _2 = j(n2, y2, h2, i2, r2, o2, e2, f2, c2, s2), d2 = y2.__e, y2.ref && h2.ref != y2.ref && (h2.ref && V(h2.ref, null, y2), s2.push(y2.ref, y2.__c || d2, y2)), null == w2 && null != d2 && (w2 = d2), 4 & y2.__u || h2.__k === y2.__k ? f2 = A(y2, f2, n2) : "function" == typeof y2.type && void 0 !== _2 ? f2 = _2 : d2 && (f2 = d2.nextSibling), y2.__u &= -7);
  return u2.__e = w2, f2;
}
function I(n2, l2, u2, t2, i2) {
  ...
  if (a2)
    for (r2 = 0; r2 < s2; r2++)
      null != (e2 = u2[r2]) && 0 == (2 & e2.__u) && (e2.__e == t2 && (t2 = C(e2)), q(e2, e2));
  return t2;
}
function A(n2, l2, u2) {
  var t2, i2;
...
function j(n2, u2, t2, i2, r2, o2, e2, f2, c2, s2) {
  var a2, h2, p2, v2, y2, g2, m2, b2, C2, S2, M2, P2, I2, A2, H, L2, T2, F2 = u2.type;
  ...
  n:
    if ("function" == typeof F2)
      try {
        if (b2 = u2.props, C2 = "prototype" in F2 && F2.prototype.render, S2 = (a2 = F2.contextType) && i2[a2.__c], M2 = a2 ? S2 ? S2.props.value : a2.__ : i2, t2.__c ? m2 = (h2 = u2.__c = t2.__c).__ = h2.__E : (C2 ? u2.__c = h2 = new F2(b2, M2) : (u2.__c = h2 = new x(b2, M2), h2.constructor = F2, h2.render = B), S2 && S2.sub(h2), h2.props = b2, h2.state || (h2.state = {}), h2.context = M2, h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), C2 && null == h2.__s && (h2.__s = h2.state), C2 && null != F2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = w({}, h2.__s)), w(h2.__s, F2.getDerivedStateFromProps(b2, h2.__s))), v2 = h2.props, y2 = h2.state, h2.__v = u2, p2)
        ...
        if (h2.context = M2, h2.props = b2, h2.__P = n2, h2.__e = false, I2 = l.__r, A2 = 0, C2) {
          for (h2.state = h2.__s, h2.__d = false, I2 && I2(u2), a2 = h2.render(h2.props, h2.state, h2.context), H = 0; H < h2._sb.length; H++)
        ...
        h2.state = h2.__s, null != h2.getChildContext && (i2 = w(w({}, i2), h2.getChildContext())), C2 && !p2 && null != h2.getSnapshotBeforeUpdate && (g2 = h2.getSnapshotBeforeUpdate(v2, y2)), f2 = $(n2, d(L2 = null != a2 && a2.type === k && null == a2.key ? a2.props.children : a2) ? L2 : [L2], u2, t2, i2, r2, o2, e2, f2, c2, s2), h2.base = u2.__e, u2.__u &= -161, h2.__h.length && e2.push(h2), m2 && (h2.__E = h2.__ = null);
      } catch (n3) {
...
function N(u2, t2, i2, r2, o2, e2, f2, c2, s2) {
  ...
  if (null === x2)
    ...
    for (a2 in k2)
      w2 = k2[a2], "children" == a2 ? y2 = w2 : "dangerouslySetInnerHTML" == a2 ? h2 = w2 : "value" == a2 ? g2 = w2 : "checked" == a2 ? m2 = w2 : c2 && "function" != typeof w2 || b2[a2] === w2 || F(u2, a2, w2, b2[a2], o2);
    if (h2)
      c2 || v2 && (h2.__html === v2.__html || h2.__html === u2.innerHTML) || (u2.innerHTML = h2.__html), t2.__k = [];
    else if (v2 && (u2.innerHTML = ""), $(u2, d(y2) ? y2 : [y2], t2, i2, r2, "foreignObject" == x2 ? "http://www.w3.org/1999/xhtml" : o2, e2, f2, e2 ? e2[0] : i2.__k && C(i2, 0), c2, s2), null != e2)
      for (a2 = e2.length; a2--; )
        _(e2[a2]);
...
function q(n2, u2, t2) {
  ...
  if (i2 = n2.__k)
    for (r2 = 0; r2 < i2.length; r2++)
      i2[r2] && q(i2[r2], u2, t2 || "function" != typeof n2.type);
...
function D(u2, t2, i2) {
  var r2, o2, e2, f2;
  t2 == document && (t2 = document.documentElement), l.__ && l.__(u2, t2), o2 = (r2 = "function" == typeof i2) ? null : i2 && i2.__k || t2.__k, e2 = [], f2 = [], j(t2, u2 = (!r2 && i2 || t2).__k = g(k, null, [u2]), o2 || p, p, t2.namespaceURI, !r2 && i2 ? [i2] : o2 ? null : t2.firstChild ? n.call(t2.childNodes) : null, e2, !r2 && i2 ? i2 : o2 ? o2.__e : t2.firstChild, r2, f2), z(e2, u2, f2);
}
...
var App = class extends x {
  ...
  render() {
    ...
    return /* @__PURE__ */ g("div", null, /* @__PURE__ */ g("button", { class: "theme-toggle", onClick: this.toggleTheme, "aria-label": "Toggle theme" }, /* @__PURE__ */ g("div", { class: "theme-toggle-inner" }, /* @__PURE__ */ g("i", { class: "fas fa-sun sun-icon" }), /* @__PURE__ */ g("i", { class: "fas fa-moon moon-icon" }))), /* @__PURE__ */ g("div", { class: "container" }, /* @__PURE__ */ g("h1", null, "AI Image Generator"), /* @__PURE__ */ g("form", { class: "input-group", onSubmit: this.handleSubmit }, /* @__PURE__ */ g(
      "input",
      {
        type: "text",
    ...
    ), /* @__PURE__ */ g("button", { type: "submit", disabled: loading }, /* @__PURE__ */ g("i", { class: "fas fa-wand-magic-sparkles" }), loading ? "Creating..." : "Create Magic")), loading && /* @__PURE__ */ g("div", { class: "loading" }, /* @__PURE__ */ g("div", { class: "loading-icons" }, /* @__PURE__ */ g("i", { class: "loading-icon fas fa-palette" }), /* @__PURE__ */ g("i", { class: "loading-icon fas fa-sparkles" }), /* @__PURE__ */ g("i", { class: "loading-icon fas fa-wand-magic" })), /* @__PURE__ */ g("div", { class: "loading-text" }, "Crafting your imagination...")), /* @__PURE__ */ g("div", { id: "result" }, error && /* @__PURE__ */ g("div", { class: "error" }, /* @__PURE__ */ g("i", { class: "fas fa-exclamation-circle" }), " ", error), imageUrl && /* @__PURE__ */ g("img", { src: imageUrl, alt: "Generated image" }))));
  }
};
D(/* @__PURE__ */ g(App, null), document.body);
